...
| 节 | 接口 | 在哪里被用到 |
|---|---|---|
| 版本 | `CB_VERSION_MAJOR` | `tests/strip_prefix.c` |
| 版本 | `CB_VERSION_MINOR` | `tests/strip_prefix.c` |
| 版本 | `CB_VERSION_PATCH` | `tests/strip_prefix.c` |
| 版本 | `CB_VERSION_STRING` | `tests/strip_prefix.c` |
| Platform Header | `CB_PATH_MAX` | `examples/14_config_switches.c` |
| General | `CB_ASSERT` | `examples/12_logging.c`、`examples/14_config_switches.c` |
| General | `CB_SHARED_STATE` | `examples/14_config_switches.c` |
| 内存分配收口 | `CB_REALLOC_RAW` | `examples/11_memory.c`、`examples/14_config_switches.c` |
| 内存分配收口 | `CB_FREE_RAW` | `examples/11_memory.c`、`examples/14_config_switches.c` |
| 内存分配收口 | `cb_alloc_report` | `examples/02_single_project.c`、`examples/03_multi_project.c`、`examples/04_two_stage.c`、`examples/11_memory.c` |
| 内存分配收口 | `cb_alloc_live_count` | `examples/11_memory.c` |
| 内存分配收口 | `cb_alloc_live_size` | `examples/11_memory.c` |
| 内存分配收口 | `CB_REALLOC` | `examples/11_memory.c`、`examples/14_config_switches.c` |
| 内存分配收口 | `CB_FREE` | `examples/11_memory.c`、`examples/14_config_switches.c` |
| 内存分配收口 | `CB_OOM` | `examples/11_memory.c`、`examples/12_logging.c`、`examples/14_config_switches.c` |
| 内存分配收口 | `cb_alloc_check` | `examples/14_config_switches.c` |
| 内存分配收口 | `cb_swap` | `examples/13_toolbox.c` |
| 内存分配收口 | `cb_shift` | `examples/13_toolbox.c`、`cb.c` |
| Logger / Panic | `CB_DEPRECATED` | `examples/14_config_switches.c` |
| Logger / Panic | `CB_ZERO` | `examples/02_single_project.c`、`examples/03_multi_project.c`、`examples/04_two_stage.c`、`examples/05_build_api.c`、`examples/06_containers.c`、`examples/07_strings.c`、`examples/08_utf8.c`、`examples/09_paths.c`、`examples/10_filesystem.c`、`examples/11_memory.c`、`examples/13_toolbox.c`、`examples/14_config_switches.c`、`tests/chain.c`、`tests/error_paths.c`、`tests/fs.c`、`tests/map.c`、`tests/nob_parity.c`、`tests/stdlib.c`、`tests/string_builder.c`、`tests/string_view.c`、`tests/toolbox.c`、`bench/bench.c` |
| Logger / Panic | `CB_ARRAY_LEN` | `examples/02_single_project.c`、`examples/03_multi_project.c`、`examples/04_two_stage.c`、`examples/05_build_api.c`、`examples/06_containers.c`、`examples/07_strings.c`、`examples/08_utf8.c`、`examples/09_paths.c`、`examples/13_toolbox.c`、`examples/14_config_switches.c`、`tests/dynamic_array.c`、`tests/nob_parity.c`、`tests/stdlib.c`、`tests/toolbox.c`、`cb.c` |
...
| Logger / Panic | `CB_WARN` | `examples/01_hello.c`、`examples/12_logging.c` |
| Logger / Panic | `CB_ERROR` | `examples/01_hello.c`、`examples/05_build_api.c`、`examples/12_logging.c`、`examples/14_config_switches.c`、`tests/read_entire_dir.c`、`tests/strip_prefix.c`、`bench/bench.c`、`cb.c` |
...
| Logger / Panic | `cb_log` | `examples/01_hello.c`、`examples/04_two_stage.c`、`examples/05_build_api.c`、`examples/12_logging.c`、`examples/14_config_switches.c`、`tests/read_entire_dir.c`、`cb.c` |
...
| Logger / Panic | `CB_PANIC_BACKTRACE` | `examples/12_logging.c`、`examples/14_config_switches.c` |
| Logger / Panic | `CB_TODO` | `examples/12_logging.c` |
| Logger / Panic | `CB_UNREACHABLE` | `examples/12_logging.c` |
| Timer | `CB_TIMER_MAX_DEPTH` | `examples/14_config_switches.c` |
...
| Arena / Temp Storage | `CB_ARENA_REGION_INIT_CAPACITY` | `examples/11_memory.c`、`examples/14_config_switches.c` |
| Arena / Temp Storage | `CB_TEMP_CAPACITY` | `examples/11_memory.c`、`examples/14_config_switches.c` |
| Arena / Temp Storage | `CB_ARENA_ALIGN` | `examples/14_config_switches.c`、`tests/arena.c` |
| Arena / Temp Storage | `CB_THREAD_LOCAL` | `examples/14_config_switches.c` |
| Arena / Temp Storage | `CB_Arena` | `examples/06_containers.c`、`examples/11_memory.c`、`examples/14_config_switches.c`、`tests/arena.c`、`tests/map.c`、`bench/bench.c` |
| Arena / Temp Storage | `CB_Arena_Mark` | `examples/11_memory.c`、`tests/arena.c`、`tests/temp_storage.c`、`bench/bench.c`、`cb.c` |
| Arena / Temp Storage | `cb_arena_alloc` | `examples/11_memory.c`、`examples/14_config_switches.c`、`tests/arena.c`、`bench/bench.c` |
...
| Arena / Temp Storage | `cb_arena_free` | `examples/06_containers.c`、`examples/11_memory.c`、`examples/14_config_switches.c`、`tests/arena.c`、`tests/map.c`、`bench/bench.c` |
...
| Arena / Temp Storage | `cb_temp_sprintf` | `examples/02_single_project.c`、`examples/03_multi_project.c`、`examples/04_two_stage.c`、`examples/11_memory.c`、`examples/14_config_switches.c`、`tests/map.c`、`tests/temp_storage.c`、`bench/bench.c`、`cb.c` |
...
| Dynamic Array | `CB_DA_INIT_CAP` | `examples/11_memory.c`、`examples/14_config_switches.c` |
| Dynamic Array | `cb_da_free` | `examples/05_build_api.c`、`examples/06_containers.c`、`examples/09_paths.c`、`examples/14_config_switches.c`、`tests/chain.c`、`tests/dynamic_array.c`、`tests/fs.c`、`tests/nob_parity.c`、`tests/stdlib.c`、`bench/bench.c` |
| Dynamic Array | `cb_da_reserve` | `examples/06_containers.c`、`bench/bench.c` |
| Dynamic Array | `cb_da_append` | `examples/06_containers.c`、`examples/14_config_switches.c`、`tests/dynamic_array.c`、`tests/stdlib.c`、`bench/bench.c`、`cb.c` |
| Dynamic Array | `cb_da_append_many` | `examples/06_containers.c`、`tests/dynamic_array.c`、`tests/stdlib.c`、`bench/bench.c` |
...
| Bitset | `CB_BITSET_WORD_BITS` | `examples/14_config_switches.c` |
...
| StringBuilder | `CB_String_Builder` | `examples/05_build_api.c`、`examples/07_strings.c`、`examples/10_filesystem.c`、`examples/11_memory.c`、`examples/14_config_switches.c`、`tests/chain.c`、`tests/error_paths.c`、`tests/fs.c`、`tests/stdlib.c`、`tests/string_builder.c`、`tests/string_view.c`、`bench/bench.c`、`cb.c` |
...
| StringBuilder | `cb_sb_append_cstr` | `examples/07_strings.c`、`tests/stdlib.c`、`tests/string_builder.c`、`bench/bench.c` |
| StringBuilder | `cb_sb_append` | `examples/07_strings.c`、`examples/14_config_switches.c`、`tests/string_builder.c` |
| StringBuilder | `cb_sb_free` | `examples/05_build_api.c`、`examples/07_strings.c`、`examples/10_filesystem.c`、`examples/11_memory.c`、`tests/chain.c`、`tests/error_paths.c`、`tests/fs.c`、`tests/stdlib.c`、`tests/string_builder.c`、`tests/string_view.c`、`bench/bench.c` |
| StringView | `CB_String_View` | `examples/07_strings.c`、`examples/08_utf8.c`、`examples/14_config_switches.c`、`tests/bytes_for_utf8.c`、`tests/nob_parity.c`、`tests/stdlib.c`、`tests/string_view.c`、`tests/strip_prefix.c`、`bench/bench.c`、`cb.c` |
...
| HashMap | `CB_MAP_INIT_CAPACITY` | `examples/11_memory.c`、`examples/14_config_switches.c` |
| HashMap | `CB_Map` | `examples/06_containers.c`、`examples/14_config_switches.c`、`tests/map.c`、`bench/bench.c` |
...
| HashMap | `cb_map_put_cstr` | `examples/06_containers.c`、`examples/14_config_switches.c`、`tests/map.c`、`bench/bench.c` |
| HashMap | `cb_map_get` | `tests/map.c` |
| HashMap | `cb_map_get_cstr` | `examples/06_containers.c`、`examples/14_config_switches.c`、`tests/map.c`、`bench/bench.c` |
...
| HashMap | `cb_map_count` | `examples/06_containers.c`、`examples/14_config_switches.c`、`tests/map.c` |
| HashMap | `cb_map_clear` | `examples/06_containers.c`、`tests/map.c` |
| HashMap | `cb_map_free` | `examples/06_containers.c`、`examples/14_config_switches.c`、`tests/map.c`、`bench/bench.c` |
| HashMap | `cb_map_iter` | `examples/06_containers.c` |
...
| File System | `CB_WIN32_ERR_MSG_SIZE` | `examples/14_config_switches.c` |
...
| File System | `cb_file_exists` | `examples/04_two_stage.c`、`examples/10_filesystem.c`、`tests/chain.c`、`tests/error_paths.c`、`bench/bench.c`、`cb.c` |
| File System | `cb_get_current_dir_temp` | `examples/09_paths.c`、`cb.c` |
| File System | `cb_set_current_dir` | `examples/09_paths.c`、`tests/error_paths.c`、`cb.c` |
...
| File System | `CB_File_Paths` | `examples/09_paths.c`、`examples/14_config_switches.c`、`tests/fs.c`、`tests/read_entire_dir.c`、`bench/bench.c` |
| File System | `cb_mkdir_if_not_exists` | `examples/02_single_project.c`、`examples/03_multi_project.c`、`examples/04_two_stage.c`、`examples/05_build_api.c`、`examples/10_filesystem.c`、`examples/14_config_switches.c`、`tests/error_paths.c`、`tests/fs.c`、`tests/read_entire_dir.c`、`bench/bench.c`、`cb.c` |
...
| File System | `cb_delete_directory_recursively` | `examples/10_filesystem.c`、`tests/error_paths.c`、`bench/bench.c`、`cb.c` |
| File System | `cb_read_entire_dir` | `examples/10_filesystem.c`、`tests/error_paths.c`、`tests/fs.c`、`tests/read_entire_dir.c` |
| File System | `cb_write_entire_file` | `examples/04_two_stage.c`、`examples/05_build_api.c`、`examples/10_filesystem.c`、`tests/chain.c`、`tests/error_paths.c`、`tests/fs.c`、`tests/nob_parity.c`、`tests/string_builder.c`、`bench/bench.c` |
...
| 路径处理 | `cb_path_join` | `examples/09_paths.c`、`tests/stdlib.c`、`bench/bench.c` |
| 路径处理 | `cb_path_normalize` | `examples/09_paths.c`、`tests/stdlib.c`、`bench/bench.c` |
...
| File System 扩展：元信息 / 递归建目录 / 原子写 / 符号链接 / glob / mmap | `cb_glob_match` | `examples/09_paths.c`、`examples/14_config_switches.c`、`tests/fs.c`、`bench/bench.c` |
...
| Math & Bits | `cb_min` | `examples/13_toolbox.c`、`examples/14_config_switches.c`、`tests/strip_prefix.c`、`tests/toolbox.c` |
| Math & Bits | `cb_max` | `examples/13_toolbox.c`、`examples/14_config_switches.c`、`tests/toolbox.c` |
| Math & Bits | `cb_clamp` | `examples/13_toolbox.c`、`examples/14_config_switches.c`、`tests/toolbox.c` |
...
| Math & Bits | `cb_rotl64` | `examples/13_toolbox.c`、`examples/14_config_switches.c`、`tests/toolbox.c`、`bench/bench.c` |
...
| Process & FD | `CB_Procs` | `examples/05_build_api.c`、`tests/nob_parity.c` |
| Process & FD | `cb_proc_wait` | `examples/05_build_api.c` |
| Process & FD | `cb_procs_wait` | `examples/05_build_api.c` |
| Process & FD | `cb_procs_wait_and_reset` | `examples/05_build_api.c`、`tests/nob_parity.c` |
...
| Cmd | `cb_cmd_free` | `examples/05_build_api.c`、`tests/chain.c`、`tests/nob_parity.c`、`bench/bench.c` |
| Cmd | `cb_cmd_to_sb` | `examples/05_build_api.c`、`bench/bench.c` |
| Cmd | `cb_nprocs` | `examples/05_build_api.c` |
...
| C Builder | `cb_needs_rebuild` | `examples/05_build_api.c`、`tests/nob_parity.c` |
...
| C Builder | `cb_cc_flags` | `examples/02_single_project.c`、`examples/03_multi_project.c`、`examples/04_two_stage.c`、`examples/05_build_api.c`、`cb.c` |
| C Builder | `cb_cc` | `examples/02_single_project.c`、`examples/03_multi_project.c`、`examples/04_two_stage.c`、`examples/05_build_api.c`、`cb.c` |
| C Builder | `cb_cc_output` | `examples/02_single_project.c`、`examples/03_multi_project.c`、`examples/04_two_stage.c`、`examples/05_build_api.c`、`cb.c` |
| C Builder | `cb_cc_inputs` | `examples/02_single_project.c`、`examples/03_multi_project.c`、`examples/04_two_stage.c`、`examples/05_build_api.c`、`cb.c` |
